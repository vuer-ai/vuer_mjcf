...
class FloatingShadowHand(Mjcf):
    _attributes = {
        "model": "shadow hand setup",
    }
...
def make_schema(**options):
    ...
    ground = GroundPlane()
    scene = FloatingShadowHand(ground, assets=assets, **options)
...
if __name__ == "__main__":
    ...
    xml_str = make_schema()
    print("Generated XML for Shadow Hand scene")
    print(xml_str)
    ...
    try:
        ...
        try:
            ...
            print("✓ Shadow Hand scene loaded successfully!")

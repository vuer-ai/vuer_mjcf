...
class FloatingWidowXArm(Mjcf):
    name = "Floating WidowX Arm"
    _attributes = {
        "model": "Trossen Widow X Arm",
    }
    ...
    def __init__(self, *_children,  **kwargs):
        ...
        robot = WidowXArm(
            ...
            **kwargs
            ...
            # Position mocap at robot's end effector
        )
...
if __name__ == "__main__":
    ...
    xml_str = make_schema()
    print("Generated XML for WidowX Arm scene")
    print(xml_str)
    ...
    try:
        ...
        try:
            ...
            print("✓ WidowX Arm scene loaded successfully!")

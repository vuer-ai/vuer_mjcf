...
class MPLRight(Body):
    ...
    _attributes = {
        "name": "mpl-right",
        "axisangle": "0 0 1 3.141592",
        "childclass": "MPL"
    }

    _mocaps_raw = """
        <body mocap="true" name="right-wrist" pos="{pos_wrist}">
            <site name="right-wrist-site" rgba="0.658 0.411 0.75 1" size="0.002 0.002 0.002"/>
        </body>

        <body mocap="true" name="right-index-finger-tip" pos="{pos_index}">
            <site name="right-index-finger-tip-site" rgba="0.658 0.411 0.75 1" size="0.002 0.002 0.002"/>
        </body>

        <body mocap="true" name="right-middle-finger-tip" pos="{pos_middle}">
            <site name="right-middle-finger-tip-site" rgba="0.658 0.411 0.75 1" size="0.002 0.002 0.002"/>
        </body>


        <body mocap="true" name="right-ring-finger-tip" pos="{pos_ring}">
            <site name="right-ring-finger-tip-site" rgba="0.658 0.411 0.75 1" size="0.002 0.002 0.002"/>
        </body>


        <body mocap="true" name="right-pinky-finger-tip" pos="{pos_pinky}">
            <site name="right-pinky-finger-tip-site" rgba="0.658 0.411 0.75 1" size="0.002 0.002 0.002"/>
        </body>


        <body mocap="true" name="right-thumb-tip" pos="{pos_thumb}" quat="0.7071 0 0 0.7071">
            <site name="right-thumb-tip-site" rgba="0.658 0.411 0.75 1" size="0.002 0.002 0.002"/>
        </body>
    """

    def __init__(self, *_children, **kwargs):
        super().__init__(*_children, **kwargs)
        self.pos_wrist = self._pos + [0, 0.07, 0]
        self.pos_index = self._pos + [-0.037, 0.255, 0]
        self.pos_middle = self._pos + [-0.013, 0.268, 0]
        self.pos_ring = self._pos + [0.01, 0.254, 0]
        self.pos_pinky = self._pos + [0.031, 0.227, 0]
        self.pos_thumb = self._pos + [-0.149, 0.125, 0]
        ...
        <geom type="cylinder" size="0.02 0.01" zaxis="0 1 0"/>
            ...
            <body name="wristy" pos="0 0 0">
                ...
                <body name="wristx" pos="-3.36826e-005 -0.0476452 0.00203763">
                    <site name="wrist_site" pos="0 -0.02 0" group="4" quat="0 0 0 1" size="0.002 0.002 0.002"/>
                                ...
                                <body name="thumb1" pos="0.0209172 -0.00084 0.0014476">
                                    ...
                                    <body name="thumb2" pos="0.0335 0 -0.0007426">
                                        ...
                                        <body name="thumb3" pos="0.0335 0 0.0010854">
                                            ...
                                            <site name="thumb_tip" pos="0.031 -0.00052 0" group="4" quat="0.7071 0 0 -0.7071" size="0.002 0.002 0.002"/>
                                        </body>
                                    </body>
                                </body>
                            </body>
                                ...
                                <body name="index1" pos="6.26e-005 -0.018 0">
                                    ...
                                    <body name="index2" pos="0.001086 -0.0435 0.0005">
                                        ...
                                        <body name="index3" pos="-0.000635 -0.0245 0">
                                            ...
                                            <site name="index_tip" pos="0 -0.025 0.00063" group="4" quat="0 0 0 1" size="0.002 0.002 0.002"/>
                                        </body>
                                    </body>
                                </body>
                            </body>
                                ...
                                <body name="middle1" pos="6.26e-005 -0.018 0">
                                    ...
                                    <body name="middle2" pos="0.001086 -0.0435 0.0005">
                                        ...
                                        <body name="middle3" pos="-0.000635 -0.0245 0">
                                            ...
                                            <site name="middle_tip" pos="0 -0.025 0.00063" group="4" quat="0 0 0 1" size="0.002 0.002 0.002"/>
                                        </body>
                                    </body>
                                </body>
                            </body>
                                ...
                                <body name="ring1" pos="6.26e-005 -0.018 0">
                                    ...
                                    <body name="ring2" pos="0.001086 -0.0435 0.0005">
                                        ...
                                        <body name="ring3" pos="-0.000635 -0.0245 0">
                                            ...
                                            <site name="ring_tip" pos="0 -0.025 0.00063" group="4" quat="0 0 0 1" size="0.002 0.002 0.002"/>
                                        </body>
                                    </body>
                                </body>
                            </body>
                                ...
                                <body name="pinky1" pos="6.26e-005 -0.0178999 0">
                                    ...
                                    <body name="pinky2" pos="0.000578 -0.033 0.0005">
                                        ...
                                        <body name="pinky3" pos="-4.78e-005 -0.0175 0">
                                            ...
                                            <site name="pinky_tip" pos="0 -0.025 0.00063" group="4" quat="0 0 0 1" size="0.002 0.002 0.002"/>
                                        </body>
                                    </body>
                                </body>
                            </body>
	...
	<equality>
        ...
        <weld site1="right-wrist-site" site2="wrist_site"/>
        <weld site1="right-index-finger-tip-site" site2="index_tip"/>
        <weld site1="right-middle-finger-tip-site" site2="middle_tip"/>
        <weld site1="right-ring-finger-tip-site" site2="ring_tip"/>
        <weld site1="right-pinky-finger-tip-site" site2="pinky_tip"/>
        <weld site1="right-thumb-tip-site" site2="thumb_tip"/>
	</equality>

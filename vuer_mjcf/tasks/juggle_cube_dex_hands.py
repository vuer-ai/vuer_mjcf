...
from vuer_mjcf.stage_sets._floating_dexhand import FloatingDexHand
...
if __name__ == "__main__":
    ...
    xml_str = make_schema()
    print("Generated XML for Juggle Cube Dex Hands task")
    print(xml_str)
    ...
    try:
        ...
        try:
            ...
            print("✓ Juggle Cube Dex Hands task loaded successfully!")

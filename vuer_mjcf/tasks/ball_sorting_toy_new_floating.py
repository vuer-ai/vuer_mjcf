...
def register(strict=True):
    ...
    add_env(
        env_id="BallSortingToyNewFloating-fixed-v1",
        entrypoint=make_env,
        kwargs=dict(
    ...
    add_env(
        env_id="BallSortingToyNewFloating-color_random-v1",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=ColorRandom,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-v1",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-fixed-lucid-v1",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer=make_schema,
            task=Fixed,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-cic_kitchen_4th_night",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
            ...
            transform_path=f"{os.environ['LUCIDSIM_EVAL_DATASETS']}/ball_sorting_toy_new_floating/cic_kitchen_4th_night",
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-cic_4th_nook",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
            ...
            transform_path=f"{os.environ['LUCIDSIM_EVAL_DATASETS']}/ball_sorting_toy_new_floating/cic_4th_nook",
            invisible_prefix=["cylinder-blue", "cylinder-orange", "ball-sorting-toy", "gripper", "ur5"],
            keyframe_file="ball_sorting_toy_new_floating.frame.yaml",
        ),
        strict=strict,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-cic_11th_kitchen",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
            ...
            transform_path=f"{os.environ['LUCIDSIM_EVAL_DATASETS']}/ball_sorting_toy_new_floating/cic_11th_kitchen",
            invisible_prefix=["cylinder-blue", "cylinder-orange", "ball-sorting-toy", "gripper", "ur5"],
            keyframe_file="ball_sorting_toy_new_floating.frame.yaml",
        ),
        strict=strict,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-cic_11th_kitchen_back",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-cic_11th_stationary",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
            ...
            transform_path=f"{os.environ['LUCIDSIM_EVAL_DATASETS']}/ball_sorting_toy_new_floating/cic_11th_stationary",
            invisible_prefix=["cylinder-blue", "cylinder-orange", "ball-sorting-toy", "gripper", "ur5"],
            keyframe_file="ball_sorting_toy_new_floating.frame.yaml",
        ),
        strict=strict,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-cic_bench",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
            ...
            transform_path=f"{os.environ['LUCIDSIM_EVAL_DATASETS']}/ball_sorting_toy_new_floating/cic_bench",
            invisible_prefix=["cylinder-blue", "cylinder-orange", "ball-sorting-toy", "gripper", "ur5"],
            keyframe_file="ball_sorting_toy_new_floating.frame.yaml",
        ),
        strict=strict,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-cic_kitchen_4th_day",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
            ...
            transform_path=f"{os.environ['LUCIDSIM_EVAL_DATASETS']}/ball_sorting_toy_new_floating/cic_kitchen_4th_day",
            invisible_prefix=["cylinder-blue", "cylinder-orange", "ball-sorting-toy", "gripper", "ur5"],
            keyframe_file="ball_sorting_toy_new_floating.frame.yaml",
        ),
        strict=strict,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-google_building_table",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
            ...
            transform_path=f"{os.environ['LUCIDSIM_EVAL_DATASETS']}/ball_sorting_toy_new_floating/google_building_table",
            invisible_prefix=["cylinder-blue", "cylinder-orange", "ball-sorting-toy", "gripper", "ur5"],
            keyframe_file="ball_sorting_toy_new_floating.frame.yaml",
        ),
        strict=strict,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-cic_12th_coffee_table",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
            ...
            transform_path=f"{os.environ['LUCIDSIM_EVAL_DATASETS']}/ball_sorting_toy_new_floating/cic_12th_coffee_table",
            invisible_prefix=["cylinder-blue", "cylinder-orange", "ball-sorting-toy", "gripper", "ur5"],
            keyframe_file="ball_sorting_toy_new_floating.frame.yaml",
        ),
        strict=strict,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-mit_medical_wood_chair",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
            ...
            transform_path=f"{os.environ['LUCIDSIM_EVAL_DATASETS']}/ball_sorting_toy_new_floating/mit_medical_wood_chair",
            invisible_prefix=["cylinder-blue", "cylinder-orange", "ball-sorting-toy", "gripper", "ur5"],
            keyframe_file="ball_sorting_toy_new_floating.frame.yaml",
        ),
        strict=strict,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-v1",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,
    ...
    add_env(
        env_id="BallSortingToyNewFloating-ball_random-gsplat-v2",
        entrypoint=make_env,
        kwargs=dict(
            xml_renderer = make_schema,
            task=BallRandom,

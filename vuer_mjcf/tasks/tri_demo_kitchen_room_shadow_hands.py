...
def make_schema(mode="cameraready", robot="panda", show_robot=False, **options):
    ...
    microwave = KitchenMicrowave(
        assets="kitchen/microwave", attributes={"pos": "0.958 -0.3 1.8", "name": "microwave", "quat": "1 0 0 0"}
    )
...
if __name__ == "__main__":
    ...
    xml_str = make_schema()
    print("Generated XML for Tri Demo Kitchen Room Shadow Hands task")
    print(xml_str)
    ...
    try:
        ...
        try:
            ...
            print("✓ Tri Demo Kitchen Room Shadow Hands task loaded successfully!")

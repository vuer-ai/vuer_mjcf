"""Tests for kitchen_room task."""

import pytest


def test_kitchen_room_xml_generation():
    """Test that kitchen_room generates valid XML."""
    from vuer_mjcf.tasks.kitchen_room import make_schema
...
def test_kitchen_room_mujoco_loading():
    """Test that kitchen_room XML can be loaded by MuJoCo."""

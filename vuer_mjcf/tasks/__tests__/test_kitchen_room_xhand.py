"""Tests for kitchen_room_xhand task."""

import pytest


def test_kitchen_room_xhand_xml_generation():
    """Test that kitchen_room_xhand generates valid XML."""
    from vuer_mjcf.tasks.kitchen_room_xhand import make_schema
...
def test_kitchen_room_xhand_mujoco_loading():
    """Test that kitchen_room_xhand XML can be loaded by MuJoCo."""

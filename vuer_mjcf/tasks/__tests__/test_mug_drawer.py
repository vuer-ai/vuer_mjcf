"""Tests for mug_drawer task."""

import pytest


def test_mug_drawer_xml_generation():
    """Test that mug_drawer generates valid XML."""
    from vuer_mjcf.tasks.mug_drawer import make_schema
...
def test_mug_drawer_mujoco_loading():
    """Test that mug_drawer XML can be loaded by MuJoCo."""

"""Tests for poncho_table task."""

import pytest


def test_poncho_table_xml_generation():
    """Test that poncho_table generates valid XML."""
    from vuer_mjcf.tasks.poncho_table import make_schema
...
def test_poncho_table_mujoco_loading():
    """Test that poncho_table XML can be loaded by MuJoCo."""

"""Tests for flip_mug task."""

import pytest


def test_flip_mug_xml_generation():
    """Test that flip_mug generates valid XML."""
    from vuer_mjcf.tasks.flip_mug import make_schema
...
def test_flip_mug_mujoco_loading():
    """Test that flip_mug XML can be loaded by MuJoCo."""

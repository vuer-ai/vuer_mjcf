"""Tests for tie_knot task."""

import pytest


def test_tie_knot_xml_generation():
    """Test that tie_knot generates valid XML."""
    from vuer_mjcf.tasks.tie_knot import make_schema
...
def test_tie_knot_mujoco_loading():
    """Test that tie_knot XML can be loaded by MuJoCo."""

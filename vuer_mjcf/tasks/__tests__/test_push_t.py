"""Tests for push_t task."""

import pytest


def test_push_t_xml_generation():
    """Test that push_t generates valid XML."""
    from vuer_mjcf.tasks.push_t import make_schema
...
def test_push_t_mujoco_loading():
    """Test that push_t XML can be loaded by MuJoCo."""

"""Tests for mug_tree_ur task."""

import pytest


def test_mug_tree_ur_xml_generation():
    """Test that mug_tree_ur generates valid XML."""
    from vuer_mjcf.tasks.mug_tree_ur import make_schema
...
def test_mug_tree_ur_mujoco_loading():
    """Test that mug_tree_ur XML can be loaded by MuJoCo."""

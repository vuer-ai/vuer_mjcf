"""Tests for pour_liquid_demo_xhand task."""

import pytest


def test_pour_liquid_demo_xhand_xml_generation():
    """Test that pour_liquid_demo_xhand generates valid XML."""
    from vuer_mjcf.tasks.pour_liquid_demo_xhand import make_schema
...
def test_pour_liquid_demo_xhand_mujoco_loading():
    """Test that pour_liquid_demo_xhand XML can be loaded by MuJoCo."""

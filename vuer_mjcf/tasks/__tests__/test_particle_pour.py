"""Tests for particle_pour task."""

import pytest


def test_particle_pour_xml_generation():
    """Test that particle_pour generates valid XML."""
    from vuer_mjcf.tasks.particle_pour import make_schema
...
def test_particle_pour_mujoco_loading():
    """Test that particle_pour XML can be loaded by MuJoCo."""

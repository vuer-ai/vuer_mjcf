"""Tests for robosuite_stack task."""

import pytest


def test_robosuite_stack_xml_generation():
    """Test that robosuite_stack generates valid XML."""
    from vuer_mjcf.tasks.robosuite_stack import make_schema
...
def test_robosuite_stack_mujoco_loading():
    """Test that robosuite_stack XML can be loaded by MuJoCo."""

"""Tests for pour_liquid task."""

import pytest


def test_pour_liquid_xml_generation():
    """Test that pour_liquid generates valid XML."""
    from vuer_mjcf.tasks.pour_liquid import make_schema
...
def test_pour_liquid_mujoco_loading():
    """Test that pour_liquid XML can be loaded by MuJoCo."""
